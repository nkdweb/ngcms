...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 12, 2015 at 12:59 PM
...
--
-- Table structure for table `ngcms_users`
--

CREATE TABLE IF NOT EXISTS `ngcms_users` (
...
--
-- Dumping data for table `ngcms_users`
--

INSERT INTO `ngcms_users` (`uid`, `name`, `email`, `phone`, `password`, `address`, `city`, `created`) VALUES
...
(187, 'Dinesh', 'nkdweb0@gmail.com', '458456485', '$2a$10$dd499d2117a3385988dd9uIMaVB3uw2URpgUWPEvDYnKQsVNct9A.', 'Bangalore', '', '2015-03-12 11:49:39');
